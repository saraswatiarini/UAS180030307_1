...
public class PerbaharuiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perbaharui);
                ...
                if (!judul.equals("") && !penulis.equals("") && !penerbit.equals("") && !tahun.equals("") && !tebal.equals("") && !isbn.equals("")) {
                    ...
                    if (imageData != null) {
                        ...
                        if (db.updateDataImage(id, judul, penulis, penerbit, tahun, tebal, isbn, loc)) {
                            Toast.makeText(getApplicationContext(), "Perbaharui data berhasil", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(getApplicationContext(), KelolaActivity.class);
                            intent.putExtra("id", id.toString());
                            startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(getApplicationContext(), "Perbaharui data gagal", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                    ...
                    Toast.makeText(getApplicationContext(), "Silahkan isi semua data dengan lengkap", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnBatal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), PilihKelolaActivity.class);
                intent.putExtra("id", id.toString());
                startActivity(intent);
                finish();
            }
